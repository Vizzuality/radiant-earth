  ...
  constructor(props) {
    ...
    this.sliderContent = [
      ...
      },
      {
        ...
        text: 'Streamline workflow by importing your existing databases directly into Radiant.Earth, and run algorithms modeling and reports for cross-domain analysisand decision-making',
        buttonText: 'REQUEST ACCESS',
        buttonUrl: '#',
      },
    ];
