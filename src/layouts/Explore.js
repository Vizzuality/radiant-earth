  ...
  constructor(props) {
    ...
    this.sliderContent = [
      ...
      },
      {
        ...
        text: 'Create secured single sign-on profile on Radiant.Earths’ cloud infrastructure, and upload, store and share drone imagery on demand for easy processing, analysis and visualization. ',
        buttonText: 'REQUEST ACCESS',
        buttonUrl: '#',
      },
      {
